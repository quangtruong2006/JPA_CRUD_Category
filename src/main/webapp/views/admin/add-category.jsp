        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <ul class="sidebar-submenu">
                    <li><a href="${pageContext.request.contextPath}/admin/category/add" class="active-sub"><i class="bi bi-plus-circle me-1"></i> Thêm danh mục mới</a></li>
        ...
        <div class="main-content">
            <div class="form-card">
                ...
                <div class="form-card-body">
                    <h3 class="fw-bold mb-4" style="color: #0f172a; font-size: 20px;">Tạo mới danh mục sản phẩm:</h3>
                    ...
                    <form action="${pageContext.request.contextPath}/admin/category/add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="preview-box-container">
                                <img id="imgPreview" src="https://placehold.co/150x100?text=Preview" class="preview-box" alt="Preview icon">
                            </div>
                            <input type="file" name="icon" id="fileInput" class="form-control" accept="image/*" onchange="previewImage(event)">
                            <small class="text-muted mt-1 d-block">Định dạng hỗ trợ: JPG, PNG, WEBP, GIF.</small>
                        </div>

                        <!-- Action Buttons -->
                        <div class="d-flex gap-3 mt-4 pt-2 border-top">
                            <button type="submit" class="btn-custom-add">
                                <i class="bi bi-plus-lg"></i> Thêm (Lưu danh mục)
                            </button>
                            <button type="reset" class="btn-custom-reset" onclick="document.getElementById('imgPreview').src='https://placehold.co/150x100?text=Preview'">
