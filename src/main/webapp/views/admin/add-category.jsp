...
<body>
                    ...
                    <form action="${pageContext.request.contextPath}/admin/category/add"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="preview-box-container">
                                ...
                                <img id="imgPreview"
                                     src="https://placehold.co/150x100?text=Preview"
                                     class="preview-box"
                                     alt="Preview">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description"
                                      ...
                                      rows="3"
                                      maxlength="500"
                                      placeholder="Nhập mô tả cho danh mục (nếu có)..."></textarea>
    ...
    <script>
        ...
        const defaultPreview =
            'https://placehold.co/150x100?text=Preview';
